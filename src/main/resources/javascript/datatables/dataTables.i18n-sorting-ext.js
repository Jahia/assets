// code to handle accent in datatables sort
...
i18nSortAscend = function (x, y) {
    return normalizeDiacritics(x).localeCompare(normalizeDiacritics(y));
};
i18nSortDescend = function (x, y) {
    return normalizeDiacritics(y).localeCompare(normalizeDiacritics(x));
};
...
$.fn.dataTableExt.oSort["string-asc"] = i18nSortAscend;
$.fn.dataTableExt.oSort["string-desc"] = i18nSortDescend;